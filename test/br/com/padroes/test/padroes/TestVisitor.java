...
import br.com.padroes.interpreter.ImpressoraVisitor;
...
public class TestVisitor {
  ...
  @Test
  public void deveTestarImpressaoDoVisitor() {
    Expressao esquerda = new Subtracao(new Numero(10), new Numero(5));
    Expressao direita = new Soma(new Numero(2), new Numero(10));
    Expressao resultado = new Soma(esquerda, direita);
    Assert.assertEquals(" (  ( 10 - 5 )  +  ( 2 + 10 )  ) ", resultado.aceitar(new ImpressoraVisitor()));
  }
